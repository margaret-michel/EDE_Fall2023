...
#4 
max_daily_22_df <- data.frame("Water_System_Name" = rep(Water_System_Name),
                              "PWSID" = rep(PWSID), 
  ...
  mutate(Date = my(paste(Month,Year))) %>% arrange(ydm(Date))
...
#6. 
#USE SEQ, MAP, BIND FUNCTIONS (SEE SLIDE 13) FOR THIS
