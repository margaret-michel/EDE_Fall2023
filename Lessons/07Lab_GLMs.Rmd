...
PM2.5byOzone.regression<-lm(formula=PM2.5~Ozone,data=EPAair)
...
#Removed Year and looked at the AIC: the best regression model is the one where all these 4 variables are kept since all AIC values are higher
```
