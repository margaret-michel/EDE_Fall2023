...
huc8_Upper_Neuse_sf<-st_read(here('Data/Spatial/NCHUC8.shp')) %>%
...
#USING GGPLOT
huc8_map <-ggplot()+
  geom_sf(data=huc8_sf,fill='orange')+ geom_sf(data=huc8_Upper_Neuse_sf,fill='purple')

#OR USING MAPVIEW
mapView(huc8_sf,col.regions='orange')+mapView(huc8_Upper_Neuse_sf,col.regions='purple')
